...
set bit_file hbe200.bit
set ltx_file hbe200.ltx
...
set_property PROBES.FILE {hbe200.ltx} [get_hw_devices ${device}]
...
set_property TRIGGER_COMPARE_VALUE eq1'bR [get_hw_probes p_0_in -of_objects [get_hw_ilas -of_objects [get_hw_devices ${device}]]]
